          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="flex-1">
              ...
              <input type="date" value={from} onChange={e => setFrom(e.target.value)}
                className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#4169E1]" />
            </div>
            <div className="flex-1">
            ...
            return (
              <div key={r.id} className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm hover:shadow-md transition-shadow flex flex-col">
                ...
                <button
                  ...
                  disabled={isLoading}
                  className="mt-5 flex items-center justify-center gap-2 w-full bg-[#4169E1] hover:bg-[#152f57] text-white text-sm font-bold py-2.5 rounded-xl transition-colors disabled:opacity-60"
                >
                  {isLoading
